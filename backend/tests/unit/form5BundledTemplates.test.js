...
describe('bundled Form 5 HTML templates', () => {
  ...
  test('form5-general fills PDF-accurate English layout', async () => {
    ...
    expect(html).toContain('class="employee-list-stamp"');
    expect(html).toContain('class="employee-list-stamp-inner"');
    ...
    expect(html).toContain('EMP.NO');
    expect(html).toContain('PT Gross');
